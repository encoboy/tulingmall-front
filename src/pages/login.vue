  ...
  <div class="login">
      ...
      <div class="container">
        <div class="login-form">
          ...
          <div class="tips">
            ...
            <div class="reg">
              <span @click="register">立即注册</span> <span>|</span
              ><span>忘记密码？</span>
            </div>
          </div>
        </div>
    ...
    <div class="footer">
      <div class="footer-link">
        <a href="http://www.tulingxueyuan.cn/" target="_blank">图灵学院</a
        ><span>|</span>
        <a href="https://ke.qq.com/course/231516?tuin=a6505b53" target="_blank"
          >腾讯课堂java架构师培训</a
        ><span>|</span>
        <a href="https://ke.qq.com/course/429988" target="_blank"
          >数据结构与算法</a
        ><span>|</span>
      ...
      this.axios
        ...
        .then(
          (res) => {
            ...
            // 拿到payloader 解码
            var tokenStr = decodeURIComponent(
              escape(window.atob(res.token.split(".")[1]))
            );
            // 转换为json对象
